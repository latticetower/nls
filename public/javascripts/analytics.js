...
window.onload = function () {
    ...
    label[1] = r.text(60, 40, "").attr(txt1).hide();
    ...
    for (var i = 0, ii = days.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            $(rect.node).hover(function () {
                ...
                label[0].attr({text: "времени: " + Math.round(data/60) + ":" + (data % 60)}).show().animateWith(frame, {x: +newcoord.x + 50, y: +newcoord.y + 12}, 200 * is_label_visible);
