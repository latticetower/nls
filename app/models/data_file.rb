...
=end  
  ...
  @rgt = (rgt == nil ? rgroup : @rgt)
    return OfficeRTF.do_rtf_group1(sender, starts_at, ends_at, rgroup, rtype) if @rgt == "1"# was rgt
    return OfficeRTF.do_rtf_group2(sender, starts_at, ends_at, rgroup, rtype) if @rgt == "2" # was rgt
